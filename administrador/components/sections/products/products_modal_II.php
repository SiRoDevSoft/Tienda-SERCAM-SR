    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="<?=$url?>/administrador/components/sections/products/products_delete.php">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="<?=$url?>/administrador/components/sections/products/products_edit.php">
                <input type="hidden" class="prodid" name="id">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <select class="form-control" id="edit_iva" name="iva">
